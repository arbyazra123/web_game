...
class GameInjector extends StatefulWidget {
  @override
  _GameInjectorState createState() => _GameInjectorState();
}

class _GameInjectorState extends State<GameInjector> {
  @override
  void initState() {
    super.initState();
    injectRPGGame();
  ...
  void injectRPGGame() async {
    await FirebaseFirestore.instance.collection(gameCollection).doc("rpg").set({
      "id": "3ea61aca-0419-483f-b740-5dc38080c10f",
      "img":
          "https://1cf7297976979c7a.azureedge.net/media/GodsWillFall/Blog%20Images/Blog%201/MTG-1.jpg",
